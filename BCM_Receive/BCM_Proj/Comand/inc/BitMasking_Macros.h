...
/************************************************************************/
#define SET_BIT(reg,gBufferIndex) (reg |= (1<<gBufferIndex))
#define CLR_BIT(reg,gBufferIndex) (reg &= (~(1<<gBufferIndex)))
#define TOG_BIT(reg,gBufferIndex) (reg ^= (1<<gBufferIndex))
#define GET_BIT(reg,gBufferIndex) ((reg >> gBufferIndex) & 0x01)
